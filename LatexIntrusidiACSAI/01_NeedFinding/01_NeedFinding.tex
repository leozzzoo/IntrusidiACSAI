...
Tutte le domande del questionario si possono visionare nel Google Form all'interno del Drive.
Di seguito visualizzeremo soltanto le domande rilevanti con le corrispettive motivazioni.

\subsubsection{Domande Corsi a Scelta (Percorso Formativo)}

\textcolor{darkblue}{\textbf{Motivazione:}Dalle interviste è emersa la poca chiarezza riguardo agli aspetti della 
compilazione del percorso formativo. Vogliamo capire attraverso questa domanda se è un problema comune degli studenti}\\
Quali dei seguenti aspetti riguardanti la compilazione del percorso formativo è risultato poco chiaro? (più scelta)
    \begin{itemize}
...
\subsubsection{Domande sulle Opinioni riguardo i Professori}
\textcolor{darkblue}{\textbf{Motivazione:} 
Con questa domanda vogliamo capire quanta importanza ci può essere nella comunicazione
tra gli studenti riguardante i professori grazie ad una scala lineare}\\
Quanto ti interessa l'opinione degli studenti riguardo i professori?
    \begin{equation*}
        \begin{array}{lllllll}
                        &  1 & 2 & 3 & 4 & 5 & \\
...
\textcolor{darkblue}{\textbf{Motivazione:} Dalle Interviste sono emerse diverse informazioni che possono interessare
agli studenti riguardo al professore. Di seguito elenchiamo le più emerse e dal questionario cerchiamo di verificare se 
possono essere informazioni importanti per gli studenti}\\
Quali informaizioni ti interessano nella ricerca del professore:
    \begin{itemize}
        \item Dati Personali 
...
\textcolor{darkblue}{\textbf{Motivazione:} Con questa scala lineare vogliamo capire se un possibile need sia la condivisione fruibile del materiale tra gli studenti}\\
Quanto la disponibilità della condivisione dei materiali dai tuoi colleghi ti può essere utile?
    \begin{equation*}
        \begin{array}{lllllll}
                        &  1 & 2 & 3 & 4 & 5 & \\
    \text { \textbf{Per Niente} } \quad \quad & \bigcirc \quad& \bigcirc \quad& \bigcirc \quad& \bigcirc \quad& \bigcirc \quad& \quad \text { \textbf{Moltissimo} }
...
\textcolor{darkblue}{\textbf{Motivazione:} Dalle interviste sono emerse i seguenti parametri riguardo la scelta del professore nello svolgere il Tirocinio.  
Dal questionario cerchiamo di verificare cerchiamo di confermare i seguenti criteri.}\\
Se utilizzi dei criteri per scegliere il professore quali sono:
    \begin{itemize}
...
\begin{center}
    \includegraphics[width=0.6\textwidth]{/Users/leonardvincentramil/Documents/GitHub/IntrusidiACSAI/LatexIntrusidiACSAI/01_NeedFinding/img/2.png}
\end{center}

\textbf{Domanda Riguardante il Professore}
\begin{center}
    \includegraphics[width=0.6\textwidth]{/Users/leonardvincentramil/Documents/GitHub/IntrusidiACSAI/LatexIntrusidiACSAI/01_NeedFinding/img/1.png}
\end{center}


\textbf{Domanda Riguardante il Tirocinio Interno}
\begin{center}
    \includegraphics[width=0.6\textwidth]{/Users/leonardvincentramil/Documents/GitHub/IntrusidiACSAI/LatexIntrusidiACSAI/01_NeedFinding/img/3.png}
\end{center}
